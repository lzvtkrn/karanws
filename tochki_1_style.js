...
var style_tochki_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("cost of lv");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1396.000000 && value <= 1500.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2000.000000 && value <= 2399.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
